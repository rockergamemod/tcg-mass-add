...
exports.Migration20251204225434 = void 0;
const migrations_1 = require("@mikro-orm/migrations");
class Migration20251204225434 extends migrations_1.Migration {
    async up() {
        ...
        this.addSql(`create table "tcg_series" ("id" serial primary key, "game_id" int not null, "code" varchar(255) not null, "name" varchar(255) not null, "logo" varchar(255) null, "display_order" varchar(255) null, "is_hidden" boolean not null default false);`);
        this.addSql(`alter table "tcg_series" add constraint "tcg_series_game_id_code_unique" unique ("game_id", "code");`);
        this.addSql(`create table "tcg_sets" ("id" serial primary key, "game_id" int not null, "code" varchar(255) null, "series_id" int null, "name" varchar(255) not null, "release_date" varchar(255) null, "is_user_visible" boolean not null default true, "logo" varchar(255) null, "type" text check ("type" in ('main', 'mini', 'promo', 'deck', 'box', 'virtual', 'other')) not null);`);
        this.addSql(`alter table "tcg_sets" add constraint "tcg_sets_game_id_code_series_id_unique" unique ("game_id", "code", "series_id");`);
        ...
        this.addSql(`create table "tcg_card_printings" ("id" serial primary key, "card_id" int not null, "finish_type" text check ("finish_type" in ('normal', 'holofoil', 'reverse-holo')) not null, "art_variant" text check ("art_variant" in ('normal', 'illustration_rare', 'alt_art')) null, "is_default" boolean not null default true);`);
...
exports.Migration20251204225434 = Migration20251204225434;
//# sourceMappingURL=Migration20251204225434.js.map